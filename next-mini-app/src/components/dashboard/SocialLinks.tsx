...
export const SocialLinks: React.FC<SocialLinksProps> = ({
  ...
  return (
    <div className="mb-6 grid grid-cols-1 gap-4">
      {/* Botón de Discord - Mejorado e integrado */}
      <Link
        href={process.env.NEXT_PUBLIC_DISCORD_URL || "https://discord.gg/BaYaaUsUuN"}
        target="_blank"
        rel="noopener noreferrer"
        className="flex items-center justify-center gap-3 px-6 py-3 rounded-full text-white font-medium transition-all duration-300 bg-[#5865F2] shadow-md hover:shadow-lg"
      ...
      {/* Botón de Telegram - Mejorado e integrado */}
      <Link
        href={process.env.NEXT_PUBLIC_TELEGRAM_URL || "https://t.me/cryptodigitaltribe"}
        target="_blank"
        rel="noopener noreferrer"
        className="flex items-center justify-center gap-3 px-6 py-3 rounded-full text-white font-medium transition-all duration-300 bg-[#0088cc] shadow-md hover:shadow-lg"
      ...
      {/* Botón de Twitter/X - Mejorado e integrado */}
      <Link
        href={process.env.NEXT_PUBLIC_TWITTER_URL || "https://x.com/TriboCDT"}
        target="_blank"
        rel="noopener noreferrer"
        className="flex items-center justify-center gap-3 px-6 py-3 rounded-full text-white font-medium transition-all duration-300 bg-gray-900 shadow-md hover:shadow-lg"
