...
export default function ProyectoTriboPage() {
  ...
  return (
    <main className="min-h-screen bg-black text-white pb-24">
      {/* Fondo con efecto de partículas mejorado */}
      <div className="fixed inset-0 z-0 pointer-events-none">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(78,189,10,0.15),transparent_70%)]"></div>
        {/* Añadir partículas sutiles */}
        <div className="absolute top-1/4 left-1/4 w-2 h-2 rounded-full bg-tribo-green-DEFAULT/30 animate-pulse"></div>
        <div
          className="absolute top-3/4 left-2/3 w-2 h-2 rounded-full bg-tribo-green-DEFAULT/30 animate-pulse"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute top-1/2 left-1/3 w-2 h-2 rounded-full bg-tribo-green-DEFAULT/30 animate-pulse"
          style={{ animationDelay: "1.5s" }}
        ></div>
        <div
          className="absolute top-1/3 right-1/4 w-2 h-2 rounded-full bg-tribo-green-DEFAULT/30 animate-pulse"
          style={{ animationDelay: "0.5s" }}
        ></div>
        <div
          className="absolute bottom-1/4 right-1/3 w-2 h-2 rounded-full bg-tribo-green-DEFAULT/30 animate-pulse"
      ...
      <div className="max-w-4xl mx-auto px-4 pt-6 relative z-10">
        ...
        {/* Nuestra Misión - Mejorada con animación y mejor contraste */}
        <div ref={(ref) => registerSectionRef("mission", ref)} id="mission" className="scroll-mt-16">
          ...
          >
            ...
            {/* Valores añadidos con mejor contraste */}
        ...
        {/* ¿Qué es CDT? - Mejorada con mejor contraste */}
        ...
        {/* Roadmap - Mejorado con mejor contraste */}
        ...
        {/* Comunidad TRIBO - Mejorada con mejor contraste */}
        <div ref={(ref) => registerSectionRef("community", ref)} id="community" className="scroll-mt-16">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              ...
              >
                <div className="w-16 h-16 rounded-full bg-tribo-green-DEFAULT/30 flex items-center justify-center text-tribo-green-DEFAULT group-hover:scale-110 transition-transform duration-300">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="32"
                    height="32"
                ...
                <div className="mt-2 px-4 py-2 rounded-full bg-tribo-green-DEFAULT text-black text-sm font-medium opacity-70 group-hover:opacity-100 transition-all duration-300">
                  {t("join_now")}
                </div>
              </a>
        ...
        {/* Próximos Pasos - Mejorado con mejor contraste */}
